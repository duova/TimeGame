...
#include "Factories/CraftingAssetFactory.h"
#include "Widgets/Layout/SUniformGridPanel.h"

#define LOCTEXT_NAMESPACE "CraftingAssetCreationDialogue"

class SCraftingAssetCreationDialogue : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SCraftingAssetCreationDialogue){}
	...
	{
		bOkClicked = false;
		ParentClass = UDA_CoreCraftingRecipe::StaticClass();
						...
						+ SVerticalBox::Slot()
							...
							[
								...
								[
									...
									.OnClicked(this, &SCraftingAssetCreationDialogue::OkClicked)
								...
								+ SUniformGridPanel::Slot(1, 0)
									[
										...
										.HAlign(HAlign_Center)
										.ContentPadding(FAppStyle::GetMargin("StandardDialog.ContentPadding"))
										.OnClicked(this, &SCraftingAssetCreationDialogue::CancelClicked)
	...
	bool ConfigureProperties(TWeakObjectPtr<UCraftingAssetFactory> InFactory)
	{
...
private:
	...
	void MakeParentClassPicker()
	{
		...
		Filter->AllowedChildrenOfClasses.Add(UDA_CoreCraftingRecipe::StaticClass());
		...
		ParentClassContainer->AddSlot()
			[
				ClassViewerModule.CreateClassViewer(Options, FOnClassPicked::CreateSP(this, &SCraftingAssetCreationDialogue::OnClassPicked))
			];
	}
	...
	TWeakObjectPtr<UCraftingAssetFactory> ItemFactory;
