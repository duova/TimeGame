...
#include "IDA_Weapon.generated.h"

/**Base class for items that can be used as a weapon. This adds a widget
 * and default containers, allowing you to store that data in here
 * rather than the item actor.
 *
 * This is meant for swords, guns and so forth.*/

class UAC_LootTable;

UCLASS()
class INVENTORYFRAMEWORKPLUGIN_API UIDA_Weapon : public UDA_CoreItem
{
	GENERATED_BODY()
