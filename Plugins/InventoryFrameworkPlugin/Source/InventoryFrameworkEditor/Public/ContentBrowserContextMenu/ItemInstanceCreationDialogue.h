...
#include "Factories/ItemInstanceFactory.h"
#include "Widgets/Layout/SUniformGridPanel.h"

#define LOCTEXT_NAMESPACE "InventoryFrameworkItemCreationDialogue"

class SItemInstanceCreationDialogue : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SItemInstanceCreationDialogue){}
	...
	{
		bOkClicked = false;
		ParentClass = UItemInstance::StaticClass();
						...
						+ SVerticalBox::Slot()
							...
							[
								...
								[
									...
									.OnClicked(this, &SItemInstanceCreationDialogue::OkClicked)
								...
								+ SUniformGridPanel::Slot(1, 0)
									[
										...
										.HAlign(HAlign_Center)
										.ContentPadding(FAppStyle::GetMargin("StandardDialog.ContentPadding"))
										.OnClicked(this, &SItemInstanceCreationDialogue::CancelClicked)
	...
	bool ConfigureProperties(TWeakObjectPtr<UItemInstanceFactory> InFactory)
	{
...
private:
	...
	void MakeParentClassPicker()
	{
		...
		Filter->AllowedChildrenOfClasses.Add(UItemInstance::StaticClass());
		...
		ParentClassContainer->AddSlot()
			[
				ClassViewerModule.CreateClassViewer(Options, FOnClassPicked::CreateSP(this, &SItemInstanceCreationDialogue::OnClassPicked))
			];
	}
	...
	FReply OkClicked()
	{
		...
		{
			ItemFactory->ItemInstanceClass = ParentClass.Get();
		}
	...
	TWeakObjectPtr<UItemInstanceFactory> ItemFactory;
