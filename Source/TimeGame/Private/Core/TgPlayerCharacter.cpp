...
void ATgPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//Bind active ability inputs.
	UEnhancedInputComponent* Input = Cast<UEnhancedInputComponent>(PlayerInputComponent);
	for (const UInputAction* Action : ActiveAbilityInputActions)
	{
		Input->BindAction<UAbilityManagerComponent, const UInputAction*, const EInputActionActivationType>(
			Action, ETriggerEvent::Started, AbilityManagerComponent, &UAbilityManagerComponent::OnInput, Action,
			EInputActionActivationType::Down);
		Input->BindAction<UAbilityManagerComponent, const UInputAction*, const EInputActionActivationType>(
			Action, ETriggerEvent::Completed, AbilityManagerComponent, &UAbilityManagerComponent::OnInput, Action,
			EInputActionActivationType::Up);
	}
}
